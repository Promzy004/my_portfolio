...
const Test: React.FC<IHomeProps> = ({darkMode}) => {
    ...
    return (
        <div className="my-[30px] xxs:my-[40px] xs:my-[50px] sm:my-[70px] w-full">
            <div 
                ref={conatinerRef}
                className={`flex bg-red-400 py-3 justify-center transition-all duration-300 ${
            ...
            >
                ...
                {/* Left cards here */}
                <div 
                    className={`relative ${!expand ? 'w-full': ''} bg-orange-300`}
                >
                    <motion.div 
                        initial={{ rotate: '-7deg' }}
                ...
                <AnimatePresence>
                    {expand && (
                        <div className={`relative ${!expandRight ? 'w-full': ''} bg-orange-300`}>
                            <motion.div 
